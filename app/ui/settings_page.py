...
class SettingsPage(QWidget):
    ...
    def _general_section(self) -> QWidget:
        ...
        self.default_language.addItems(["English", "Arabic", "Italian"])
    ...
    def _reports_section(self) -> QWidget:
        ...
        self.report_language.addItems(["English", "Arabic", "Italian"])
    ...
    def _load_settings(self) -> None:
        with session_scope() as session:
            ...
            self.logo_path.setText(values.get("report_logo_path", ""))
        ...
        try:
            with session_scope() as session:
                ...
                settings.update_many(
                    {
                        "owner_name": self.report_owner.text().strip(),
